...
async def deal_type_callback(callback: CallbackQuery):
    ...
    lang = user_languages.get(callback.from_user.id, "ru")
    await safe_edit_message(callback, "🛡 Создание сделки
...
t.me/nft/EternalRose-3" if lang == "ru" else "🛡 Create a transaction

🎁 Enter the gift link(s) in one of the formats:
https://... or t.me/...

For example:
t.me/nft/DurovsCap-1

If you have multiple gifts, include each link on a new line, for example:

t.me/nft/DurovsCap-1
t.me/nft/PlushPepe-2
t.me/nft/EternalRose-3", back_keyboard_ru if lang == "ru" else back_keyboard_en)
